...
var app = (function () {
    ...
    /* src\components\Inputs\TextInput.svelte generated by Svelte v3.49.0 */

    const file$4 = "src\\components\\Inputs\\TextInput.svelte";

    function create_fragment$4(ctx) {
    	let div;
    	let label;
    	let t0_value = /*inputName*/ ctx[1].charAt(0).toUpperCase() + /*inputName*/ ctx[1].slice(1) + "";
    	let t0;
    	let t1;
    	let t2;
    	let input;
    	...
    	const block = {
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*inputName*/ 2 && t0_value !== (t0_value = /*inputName*/ ctx[1].charAt(0).toUpperCase() + /*inputName*/ ctx[1].slice(1) + "")) set_data_dev(t0, t0_value);
    ...
    class TextInput extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*inputName*/ ctx[1] === undefined && !('inputName' in props)) {
    			console.warn("<TextInput> was created without expected prop 'inputName'");
    		}
    ...
    /* src\components\Inputs\EmailInput.svelte generated by Svelte v3.49.0 */

    const file$3 = "src\\components\\Inputs\\EmailInput.svelte";
    ...
    class EmailInput extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*inputName*/ ctx[1] === undefined && !('inputName' in props)) {
    			console.warn("<EmailInput> was created without expected prop 'inputName'");
    		}
    ...
    /* src\components\Inputs\TextArea.svelte generated by Svelte v3.49.0 */

    const file$2 = "src\\components\\Inputs\\TextArea.svelte";
    ...
    class TextArea extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*inputName*/ ctx[1] === undefined && !('inputName' in props)) {
    			console.warn("<TextArea> was created without expected prop 'inputName'");
    		}
    ...
    /* src\components\Alerts\Alert.svelte generated by Svelte v3.49.0 */

    const file$1 = "src\\components\\Alerts\\Alert.svelte";
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span0, file$1, 6, 2, 200);
    			add_location(title, file$1, 9, 8, 461);
    			...
    			add_location(path, file$1, 10, 8, 491);
    			attr_dev(svg, "class", svg_class_value = "fill-current h-6 w-6 " + /*textStyle*/ ctx[4]);
    			attr_dev(svg, "role", "button");
    			attr_dev(svg, "xmlns", "http://www.w3.org/2000/svg");
    			attr_dev(svg, "viewBox", "0 0 20 20");
    			add_location(svg, file$1, 8, 4, 312);
    			attr_dev(span1, "class", "absolute top-0 bottom-0 right-0 px-4 py-3");
    			add_location(span1, file$1, 7, 2, 250);
    			attr_dev(div, "class", div_class_value = "border px-4 py-3 rounded relative " + /*containerStyle*/ ctx[3]);
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(
    					...
    					"click",
    					function () {
    						if (is_function(/*closeAlert*/ ctx[2])) /*closeAlert*/ ctx[2].apply(this, arguments);
    					},
    					false,
    					false,
    					false
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			if (dirty & /*textStyle*/ 16 && svg_class_value !== (svg_class_value = "fill-current h-6 w-6 " + /*textStyle*/ ctx[4])) {
    				attr_dev(svg, "class", svg_class_value);
    			}

    			if (dirty & /*containerStyle*/ 8 && div_class_value !== (div_class_value = "border px-4 py-3 rounded relative " + /*containerStyle*/ ctx[3])) {
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	let { message, visible = false, closeAlert, containerStyle, textStyle } = $$props;
    	const writable_props = ['message', 'visible', 'closeAlert', 'containerStyle', 'textStyle'];
    	...
    	$$self.$$set = $$props => {
    		...
    		if ('textStyle' in $$props) $$invalidate(4, textStyle = $$props.textStyle);
    	};
    	...
    	return [message, visible, closeAlert, containerStyle, textStyle];
    }
    ...
    class Alert extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*closeAlert*/ ctx[2] === undefined && !('closeAlert' in props)) {
    			console.warn("<Alert> was created without expected prop 'closeAlert'");
    		}

    		if (/*containerStyle*/ ctx[3] === undefined && !('containerStyle' in props)) {
    			console.warn("<Alert> was created without expected prop 'containerStyle'");
    		}

    		if (/*textStyle*/ ctx[4] === undefined && !('textStyle' in props)) {
    			console.warn("<Alert> was created without expected prop 'textStyle'");
    		}
    	}
    ...
    function create_fragment(ctx) {
    	...
    	alert_1 = new Alert({
    			props: {
    				...
    				closeAlert: /*toggleAlertVisible*/ ctx[9],
    				isErrorAlert: /*isErrorAlert*/ ctx[7],
    				containerStyle: /*containerStyle*/ ctx[5],
    				textStyle: /*textStyle*/ ctx[6]
    			},
    			$$inline: true
    		});
    	...
    	binding_callbacks.push(() => bind$1(emailinput, 'value', emailinput_value_binding));
    	...
    	const block = {
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (!updating_value && dirty & /*name*/ 1) {
    				updating_value = true;
    				textinput_changes.value = /*name*/ ctx[0];
    			...
    			if (!updating_value_1 && dirty & /*email*/ 2) {
    				...
    				emailinput_changes.value = /*email*/ ctx[1];
    			...
    			if (!updating_value_2 && dirty & /*description*/ 4) {
    				...
    				textarea_changes.value = /*description*/ ctx[2];
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	const onSubmit = async () => {
    		...
    		$$invalidate(0, name = $$invalidate(1, email = $$invalidate(2, description = null)));
    		...
    		$$invalidate(7, isErrorAlert = false);
    		$$invalidate(5, containerStyle = "bg-teal-100 border-teal-500 text-teal-900");
    		$$invalidate(6, textStyle = "text-teal-500");
    		$$invalidate(3, message = 'Thank you for filling out your information!');
    		toggleAlertVisible();
    		return;
    	};

    	const storeForm = async () => {
    		return axios.post('http://localhost:8080/form', { name, email, description }, {
    			headers: {
    				'Content-Type': 'application/json',
    	...
    	const toggleAlertVisible = () => {
    		$$invalidate(4, alertVisible = !alertVisible);
    	};
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('alertVisible' in $$props) $$invalidate(4, alertVisible = $$props.alertVisible);
    		if ('containerStyle' in $$props) $$invalidate(5, containerStyle = $$props.containerStyle);
    		if ('textStyle' in $$props) $$invalidate(6, textStyle = $$props.textStyle);
    		if ('isErrorAlert' in $$props) $$invalidate(7, isErrorAlert = $$props.isErrorAlert);
    	};
